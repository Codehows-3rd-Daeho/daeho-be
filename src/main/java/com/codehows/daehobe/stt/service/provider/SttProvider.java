...
public interface SttProvider {
     ...
     * @return 비동기 작업 ID (rid)
     */
    String requestTranscription(Resource audioFile);
     ...
     * @return STT 결과
     */
    SttTranscriptionResult checkTranscriptionStatus(String jobId);
     ...
     * @return 비동기 작업 ID (rid)
     */
    String requestSummary(String text);
     ...
     * @return 요약 결과
     */
    SttSummaryResult checkSummaryStatus(String jobId);
}

...
public final class KafkaConstants {
    ...
    public static final String STT_ABNORMAL_TERMINATION_TOPIC = "stt-abnormal-termination-topic";
    ...
    public static final String STT_ABNORMAL_TERMINATION_GROUP = "stt-abnormal-termination-group";

...
import com.codehows.daehobe.masterData.entity.*;
import com.codehows.daehobe.masterData.repository.*;
...
public class InitialDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (categoryRepository.count() == 0) {
            ...
            System.out.println("Category 기초 데이터 생성 완료");
        }
        ...
        if (departmentRepository.count() == 0) {
            ...
            System.out.println("Department 기초 데이터 생성 완료");
        }
        ...
        if (jobPositionRepository.count() == 0) {
            ...
            System.out.println("JobPosition 기초 데이터 생성 완료");
        }
        ...
        if (allowedExtensionRepository.count() == 0) {
            ...
            System.out.println("AllowedExtension 기초 데이터 생성 완료");
        }
        // ================= 최대 파일 사이즈 =================
        if (maxFileSizeRepository.count() == 0) {
            ...
            System.out.println("MaxFileSize 기초 데이터 생성 완료 (10MB)");
        }
    }

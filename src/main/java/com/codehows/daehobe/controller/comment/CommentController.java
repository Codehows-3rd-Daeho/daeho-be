...
public class CommentController {
    ...
    public ResponseEntity<?> createComment(@RequestBody CommentRequest dto, @PathVariable Long id, Authentication authentication){
        String memberId = authentication.getName();

        Comment comment = commentService.createComment(id, dto, Long.valueOf(memberId));
